# -*- coding: utf-8 -*-
"""
Created on Thu May 31 08:51:31 2018
...
class envh:
    ...
    def step(self,state1, a):
        ...
        B_1 = max(min(B_1 + self.eh1 - (p1 + p2) * self.Ts-y1*aq, self.Bmax),0)
        ...
        B_3 = max(min(B_3 + self.eh3 - p4 * self.Ts + aq*(y1-y2), self.Bmax),0)
    ...
    def step1(self, a):
        ...
        self.state = np.array([newB_1, newB_2, newB_3])
